              ...
              <div id='profil_orta_orta'>
                ...
                <div id='profil_sag_genel'>
                  ...
                  if (profil_hesap_aktifmi($baglan, $_SESSION["kadi"])) {?>
                    ...
                    echo "<div id='anket_paylasilmamis_profil' >Hesabın aktif değil bu yüzden şu anda anket paylaşamazsın! <br> <a href='$site_url/mobil/onay-maili-gonder'> <u>Buraya</u></a> tıklayıp yeniden onay maili gönderebilirsin.</div>";
                    echo "</div>";
                  }
